from Mapa import MapaDepartamental, MapaMunicipal
...
def mapa_categorias(tipo, ruta_mapa, ruta_excel, variable_union ,variable_pintar, tam_letra_mapa,
    ...
    mapa.proyecto.addMapLayer(mapa)
    ...
    return mapa.get_categories(mapa_copia)
